  ...
  return (
    <SafeAreaView className="flex-1 bg-purple-600">
      <View className="flex-1 items-center pt-5">
        <Svg fill="#000000" width="100px" height="100px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
        ...
        <Text className="text-5xl p-2 text-white font-bold text-center">ChoosePhone Admin felület</Text>
        <Text className="text-white text-center text-3xl w-4/5 mt-3 py-1 bg-slate-400 opacity-95 rounded-md">Üdvözöljük a ChoosePhone Admin felületén! Tekintse meg az adatbázisban lévő telefonok adatait!</Text>
