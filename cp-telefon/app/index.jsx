  ...
  return (
    <SafeAreaView className="flex-1 bg-purple-600">
      <View className="flex-1 items-center pt-5">
        ...
        <Text className="text-3xl p-2 text-white font-bold text-center">ChoosePhone Admin felület</Text>
        <Text className="text-white text-center w-4/5 mt-3 py-1 bg-slate-400 opacity-95 rounded-md">Üdvözöljük a ChoosePhone Admin felületén! Tekintse meg az adatbázisban lévő telefonok adatait!</Text>
